...
from minbpe_exercise import MyBasicTokenizer
...
@pytest.mark.parametrize("tokenizer_factory", [BasicTokenizer, RegexTokenizer, GPT4Tokenizer, MyBasicTokenizer])
...
@pytest.mark.parametrize("tokenizer_factory", [BasicTokenizer, RegexTokenizer, MyBasicTokenizer])
